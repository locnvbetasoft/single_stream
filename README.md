...
**beIN Sports Haber**
  ``` https://canlitvulusal3.xyz/live/beinsportshaber/index.m3u8   ```
...
**Contacto Deportivo (720p) [Not 24/7]**
...
**ESPN U (720p)**
  ``` http://fl3.moveonjoy.com/ESPN_U/index.m3u8   ```

**ESPNews (720p)**
  ``` http://fl3.moveonjoy.com/ESPN_NEWS/index.m3u8   ```

**Esport3 (1080p) [Geo-blocked]**
  ``` https://directes-tv-cat.3catdirectes.cat/live-origin/esport3-hls/master.m3u8   ```

**ESR 24x7 eSports Network (1080p)**
...
**Hipódromo de las Américas (480p) [Geo-blocked]**
...
**Insight TV (720p)**
  ``` https://insig  ``` httv-samsungau.amagi.tv/playlist.m3u8   ```
...
**MLB Network**
  ``` http://fl3.moveonjoy.com/MLB_NETWORK/index.m3u8   ```
